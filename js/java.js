    ...
    .then((data) => {
        ...
        function mostrarPagina(pagina) {
            ...
            `;
                ...
                if (ejercicio.uml) {
                    const umlDiv = document.createElement("div");
                    umlDiv.classList.add("uml-diagrama");
                    umlDiv.innerHTML = `
            <img src="${ejercicio.uml}" alt="Diagrama UML del ejercicio" style="max-width: 100%; height: auto;" />
          `;

                    articulo.appendChild(umlDiv);
                }
        ...
        function actualizarPaginacion() {
            ...
            const sigPag = document.getElementById("anterior-pagina");
